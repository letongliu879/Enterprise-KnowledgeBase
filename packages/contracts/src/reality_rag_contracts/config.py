"""Shared indexing configuration for cross-service use.

This module provides environment-based configuration loading and model name
normalization used by both indexing-service and ragflow-runtime.
"""
