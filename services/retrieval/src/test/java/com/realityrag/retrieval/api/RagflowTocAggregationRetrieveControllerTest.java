...
class RagflowTocAggregationRetrieveControllerTest extends AbstractPostgresTestBase {
    @Autowired
    ...
    void retrieveAddsChunksFromTocSelection() throws Exception {
        ...
        mockMvc.perform(post("/internal/retrieve")
            ...
            .andExpect(jsonPath("$.evidence_items[0].evidence_id").value("chk_policy_other_0003"))
            .andExpect(jsonPath("$.evidence_items[0].source_stage").value("ragflow_toc_aggregate"));
    }
}
