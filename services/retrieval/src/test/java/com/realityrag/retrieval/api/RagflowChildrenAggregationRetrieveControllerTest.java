...
class RagflowChildrenAggregationRetrieveControllerTest {
    @Autowired
    ...
    void retrieveAggregatesChildrenIntoParentChunk() throws Exception {
        ...
        mockMvc.perform(post("/internal/retrieve")
            ...
            .andExpect(jsonPath("$.result_chunks[0].chunk_id").value("chk_policy_parent_0001"))
            .andExpect(jsonPath("$.result_chunks[0].source_stage").value("ragflow_children_aggregate"));
    }
}
