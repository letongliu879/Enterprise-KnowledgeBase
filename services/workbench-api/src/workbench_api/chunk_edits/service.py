...
class ChunkEditService:
    ...
    async def submit_chunk_edit(self, chunk_edit_id: str, user: CurrentUser) -> WorkbenchChunkEdit | None:
        ...
        command = {
            ...
            "target_type": "chunk",
            "target_id": edit.base_evidence_id,
            "payload": {
                "evidence_id": edit.base_evidence_id,
                "doc_id": edit.source_file_id,
        ...
        result = await self._indexing_client.create_chunk_revision(edit.base_evidence_id, command)
        edit.downstream_revision_id = result.get("revision_id")
